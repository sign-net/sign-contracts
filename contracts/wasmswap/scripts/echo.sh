...
MOON=$(signd query wasm list-contract-by-code 1 --output json | jq -r '.contracts[-2]')
USIGN_MOON_TOKEN=$(signd query wasm list-contract-by-code 1 --output json | jq -r '.contracts[-1]')
